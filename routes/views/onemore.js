...
exports = module.exports = function(req, res) {
	...
	view.on('post', function(next) {
		...
		var plantsArr = JSON.parse(fs.readFileSync('./public/vendorsFull/' + vendorLow + 'AllFull.json', 'utf8'));
console.log(plantsArr.length);
		...
		fs.writeFile('./public/vendorsFullF/' + vendorLow + 'AllFull.json', JSON.stringify(plantsArr, null, 2));
		next();
	});
